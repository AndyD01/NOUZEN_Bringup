...
def generate_launch_description():
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("nouzen_bringup"), "description", "urdf", "nouzen.urdf.xacro"]
            ),
        ]
    )
    robot_description = {"robot_description": ParameterValue(robot_description_content, value_type=str)}
    #robot_description = {"robot_description": robot_description_content}
    description_dir = get_package_share_directory('nouzen_bringup')
    ...
    launch_robot_hardware = PathJoinSubstitution([
          bringup_dir, 'bringup', 'launch', 'nouzen_base.launch.py'])
    ...
    urdf = os.path.join(description_dir, 'urdf', 'nouzen.urdf.xacro')
    control_config = PathJoinSubstitution([bringup_dir, 'config', 'nouzen_controllers.yaml'])
